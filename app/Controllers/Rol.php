...
class Rol extends BaseController
{
    ...
    {
        $this->rol_model = new RolModel();
    }

    public function generateTable()
    {
        /**recuperar datos de la DB */
        $rol_list = $this->rol_model->orderBy('nombre','ASC')->findAll();
    ...
    public function edit($token = null)
    {
        ...
        $data['obj'] = $this->rol_model->find($token);
        if ($data['obj'] == null) {
            return redirect()->to('/complejo');
        };
    ...
    public function changeStatus($id)
    {
        ...
        echo ($this->rol_model->save(['id_complejo' => $id, 'valido' => $estado==0?false:1]));
    }
}
