...
<div id="left-sidebar" class="sidebar" style="z-index: 9;">
    <h5 class="brand-name">Escuela-Futbol<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
        ...
        <div class="tab-pane fade <?= session()->get('leftbar_section') == 'Escuela' ? 'show active' : '' ?>" id="menu-uni" role="tabpanel">
            <nav class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li <?= session()->get('leftbar_link') == 'Tutor' ? 'class="active"' : '' ?>><a href="<?= base_url() ?>tutor"><i class="fa fa-male fa-users"></i><span>Tutores</span></a></li>
