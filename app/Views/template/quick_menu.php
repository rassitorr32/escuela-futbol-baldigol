...
<div class="user_div">
    <ul class="nav nav-tabs">
        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#righttab-statistics">Resumen</a></li>
    </ul>
        ...
        <div class="tab-pane fade show active" id="righttab-statistics" role="tabpanel">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="py-3 m-0 text-center h1 text-success">Bs.
                        <?php

                        use App\Models\PagoModel;

                        $pago_model = new PagoModel();
                        echo ($pago_model->selectSum('monto_pagado','total_pagos')->first())['total_pagos'];
                        ?>
                    </div>
                    <!-- <div class="d-flex">
                ...
                <div class="card-body top_counter">
                    ...
                    <div class="content">
                        ...
                        <h5 class="number mb-0">
                            ...
                            $estudiante_model = new EstudianteModel();
                            echo count($estudiante_model->getEstudiantesWithPersona());
                            ?>
                        </h5>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body top_counter">
                    <div class="icon bg-dark"><i class="fa fa-user-circle-o"></i> </div>
                    <div class="content">
                        <span>Personal Total</span>
                        <h5 class="number mb-0">
                            <?php
                            $usuario_model = new UsuarioModel();
                            echo count($usuario_model->findAll());
                            ?>
                        </h5>
                    </div>
                </div>
